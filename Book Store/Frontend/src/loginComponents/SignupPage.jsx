...
const SignupPage =  () => {
  ...
  return (
    ...
    <div>
          <h1 className="font-bold text-3xl md:text-3xl pl-1.5">Sign <span className="text-[#ff3b85]">UP</span></h1>
    </div>
<div >
      <form onSubmit={handleSubmit(onSubmit)} className="max-w-sm mx-auto p-6 rounded-xl  shadow-2xl   bg-white text-gray-900 scale-3d">
        ...
        <div className="flex items-start mb-5">
          ...
          <label  htmlFor="terms" className="ms-2 text-sm font-medium  ">I agree with this </label>
          <a href="#" className="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 text-center font-bold">Terms and conditions</a>
        </div>
