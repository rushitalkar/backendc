...
<div className='flex justify-between'>
  ...
  <button ><X className=' cursor-pointer' /></button>
  ...
  <div className='flex justify-between'>
    ...
    <button    className="cursor-pointer bg-pink-500 hover:bg-pink-600 focus:ring-4 focus:outline-none focus:ring-blue-200 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center  "><NavLink to='/signup'>Signup</NavLink></button>
